...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'DHT', "template")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Telegram settings
TELEGRAM_TOKEN = '6683047762:AAGXACmloB7q-_AbiJYkiv8E1Fc4ea4vh30'
TELEGRAM_CHAT_ID = '6236806465'
